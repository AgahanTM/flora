...
func main() {
	...
	ctrls := &routes.Controllers{
		...
		Product:         controllers.NewProductController(productService, sellerService),
		Personalization: controllers.NewPersonalizationController(personalizationService),
		Order:           controllers.NewOrderController(orderService, sellerService),
		...
		Review:          controllers.NewReviewController(reviewService, sellerService),
