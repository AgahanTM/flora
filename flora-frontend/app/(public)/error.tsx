  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-3xl font-display font-bold text-bark mb-4 italic">
        Something went <span className="text-rose">wrong</span>
      </h2>
      <p className="text-bark/60 max-w-md mb-10 leading-relaxed font-medium">
        We encountered an unexpected aromatic hiccup. Our curators are already on the case to fix this floral disturbance.
      </p>
